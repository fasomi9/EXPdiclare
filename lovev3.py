...
class decllove(loader.Module):
    ...
    strings_ru = {
        ...
        "ily_love": [
            ...
            "<i>читайте,когда тебе будет грустно и плохо.<br>ОН ЛЮБИТ ВАС И СИЛЬНО СКУЧАЕТ<br>ЕМУ НЕ ХВАТАЕТ ВАС, не хватает ваших милых разговоров, вашей милой улыбки рядом, ваших красивых глазок.<br>не хватает так же объятий теплых,которые греют не только тело, но и душу
</i>",
