...
class decllove(loader.Module):
    ...
    strings_ru = {
        ...
        "ily_love": [
            ...
            "<i>senorita, tu es belle comme le premier paysage matinal dans une nature dense, comme un chaud rayon de soleil par une journée froide et maussade.<br>En te voyant j'admire, j'admire ton sourire, tes yeux et ta beauté</i>",
