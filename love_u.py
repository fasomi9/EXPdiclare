...
class Declaration(loader.Module):
    ...
    strings_ru = {
        ...
        "ily_love": [
            ...
            "🤗 <i>Это искренние чувства... поэтому прошу принять это к сведению и не сильно злиться на него, потому что он это говорит через модуль.</i>",
            "🫶 <i>Лучше ничего не говорите ему о нашем диалоге. ваш любимый Bloody.🙂</i>",
        ],
